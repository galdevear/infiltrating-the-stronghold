...
tag @s remove veer.fsh.entity.new
tag @s[tag=!veer.fsh.entity] add veer.fsh.entity.new
tag @s[tag=!veer.fsh.entity] add veer.fsh.entity

#> Silverfish
# Also includes silverfish queen endermite spawning. (any silverfish in stronghold)
execute as @s[type=silverfish, tag=veer.fsh.entity.new,tag=!global.ignore,tag=!global.ignore.pos] run function veer:fsh/silverfish/init

#> Watcher Spawning
# Swap some new spawns with a pair of watchers
execute as @s[type=#veer:fsh/watcher_pair/replaceable,tag=veer.fsh.entity.new,tag=!global.ignore,tag=!global.ignore.pos, predicate=veer:fsh/in_stronghold] run function veer:fsh/watcher_pair/init_replaceable
...
#> Potion effect tears
#   Obsidian Watcher
execute as @s[type=ender_pearl,tag=veer.fsh.obsidian_watcher, predicate=veer:fsh/obsidian_watcher/can_cry] run function veer:fsh/obsidian_watcher/attack
#   End Watcher
execute as @s[type=ender_pearl,tag=veer.fsh.end_watcher, predicate=veer:fsh/end_watcher/can_cry] run function veer:fsh/end_watcher/attack
