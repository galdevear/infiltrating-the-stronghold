...
# Initialize old
execute positioned ^ ^ ^-0.5 run function veer:fsh/sculk_watcher/cry/detect_wall/2d/micro_init_old
execute positioned ^ ^ ^-0.5 run function veer:fsh/sculk_watcher/cry/detect_wall/3d/micro_init_old

# If halfway behind the current block is not blocked, check for entities up till that point
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 positioned ^ ^ ^-0.25 run function veer:fsh/sculk_watcher/cry/detect_wall/1d/micro
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 positioned ^ ^ ^-0.25 run function veer:fsh/sculk_watcher/cry/detect_wall/2d/micro
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 positioned ^ ^ ^-0.25 run function veer:fsh/sculk_watcher/cry/detect_wall/3d/micro
...
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 run function veer:fsh/sculk_watcher/cry/detect_wall/1d/micro
...
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 run function veer:fsh/sculk_watcher/cry/detect_wall/3d/micro
