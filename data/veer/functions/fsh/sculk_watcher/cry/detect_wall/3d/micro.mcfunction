...
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^ ^0.353553390593 ^0.25 #veer:fsh/seethrough run scoreboard players set $up veer.fsh.sculk_watcher.cry 1 
# get left down
# positioned ^sqrt(3)/(4*sqrt(2)) ^-1/(4*sqrt(2)) ^0.25
# positioned ^0.306186217848 ^-0.176776695297 ^0.25
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^0.306186217848 ^-0.176776695297 ^0.25 #veer:fsh/seethrough run scoreboard players set $leftDown veer.fsh.sculk_watcher.cry 1
# get right down
# positioned ^-sqrt(3)/(4*sqrt(2)) ^-1/(4*sqrt(2)) ^0.25
# positioned ^-0.306186217848 ^-0.176776695297 ^0.25
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^-0.306186217848 ^-0.176776695297 ^0.25 #veer:fsh/seethrough run scoreboard players set $rightDown veer.fsh.sculk_watcher.cry 1
...
# positioned ^ ^-0.353553390593 ^0.25
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^ ^-0.353553390593 ^0.25 #veer:fsh/seethrough run scoreboard players set $down veer.fsh.sculk_watcher.cry 1 
# get left up
# positioned ^sqrt(3)/(4*sqrt(2)) ^1/(4*sqrt(2)) ^0.25
# positioned ^0.306186217848 ^0.176776695297 ^0.25
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^0.306186217848 ^0.176776695297 ^0.25 #veer:fsh/seethrough run scoreboard players set $leftUp veer.fsh.sculk_watcher.cry 1
# get right up
# positioned ^-sqrt(3)/(4*sqrt(2)) ^1/(4*sqrt(2)) ^0.25
# positioned ^-0.306186217848 ^0.176776695297 ^0.25
execute if score $seesEntity veer.fsh.sculk_watcher.cry matches -1 unless block ^-0.306186217848 ^0.176776695297 ^0.25 #veer:fsh/seethrough run scoreboard players set $rightUp veer.fsh.sculk_watcher.cry 1
