...
execute at @s run summon silverfish ~ ~-64 ~ {Silent:1b,NoGravity:1b,Tags:["global.ignore","global.ignore.pos","veer.fsh.silverfish.battlecryer","veer.fsh.silverfish.battlecryer.new", "veer.fsh.silverfish.battlecryer.retToY","veer.fsh.entity"],ActiveEffects:[{Id:7,Amplifier:0b,Duration:1,ShowParticles:0b},{Id:14,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Attributes:[{Name:"generic.armor",Base:100.0}]}
