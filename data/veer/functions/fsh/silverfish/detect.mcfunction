...
execute as @e[type=silverfish,tag=veer.fsh.silverfish.battlecryer.retToY,scores={veer.fsh.sbTimer = 0}] run execute store result entity @s Pos[1] double 1 run scoreboard players get @s veer.fsh.ssb.ay
...
scoreboard players add @e[type=silverfish, tag=veer.fsh.silverfish.battlecryer] veer.fsh.sbTimer 1