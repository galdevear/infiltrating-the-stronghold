...
execute positioned ~ ~0.1 ~ run summon endermite ~ ~ ~ {Lifetime:770,DeathLootTable:"veer:fsh/empty",Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:infested_chiseled_stone_bricks"},Time:-1600,DropItem:0b}], Attributes:[{Name:"generic.armor",Base:1},{Name:"generic.attack_damage",Base:4},{Name:"generic.attack_knockback",Base:0.05}]}
