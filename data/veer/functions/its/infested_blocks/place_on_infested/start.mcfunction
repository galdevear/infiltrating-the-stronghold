advancement revoke @s only veer:its/infested_blocks/place_on_infested
...
execute at @s anchored eyes positioned ^ ^ ^ run function veer:its/infested_blocks/place_on_infested/loop