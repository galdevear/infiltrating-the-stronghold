...
execute if score $seesEntity veer.its.sculk_watcher.cry matches 0 run function veer:its/sculk_watcher/cry/detect_wall/detect
...
execute if score $seesEntity veer.its.sculk_watcher.cry matches 1 if entity @s[type=#veer:its/sculk_watcher/cry/startle] if score @s veer.its.sculk_watcher.cry.startleDuration matches 3.. run scoreboard players set $seesEntity veer.its.sculk_watcher.cry -1

## Recurse
# Iterate steps
scoreboard players add $steps veer.its.sculk_watcher.cry 1
# Recursive call
execute if score $seesEntity veer.its.sculk_watcher.cry matches 0 positioned ^ ^ ^0.5 run function veer:its/sculk_watcher/cry/trace_loop

## Return
# execute if score $seesEntity veer.its.sculk_watcher.cry matches 1 run particle crimson_spore ~ ~ ~ 0 0 0 0 1 force @a
